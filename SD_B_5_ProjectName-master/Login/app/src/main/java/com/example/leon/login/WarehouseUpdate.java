...
public class WarehouseUpdate extends OperationActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_warehouse_update);
    ...
    private void add() {
        if (email.getText().toString().isEmpty() && street_address.getText().toString().isEmpty() &&
            ...
            Toast.makeText(WarehouseUpdate.this, "At least one of the fields is empty.", Toast.LENGTH_LONG).show();
    ...
    private void displayInfo() {
        AlertDialog.Builder adb = new AlertDialog.Builder(WarehouseUpdate.this, R.style.MyAlertDialogStyle);
        adb.setTitle("Update the warehouse information");
