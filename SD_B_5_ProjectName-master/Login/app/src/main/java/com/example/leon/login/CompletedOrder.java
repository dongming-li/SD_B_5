...
public class CompletedOrder extends OperationActivity
{
	...
	private final String DATA_URL_ORDER_COMPLETED = "http://proj-309-sd-b-5.cs.iastate.edu/database/search_order.php?" +
			"company_id=" + MainActivity.company_id + "&location_id=" + MainActivity.location_id + "&status=2";
	...
	{
		String url = DATA_URL_ORDER_COMPLETED;
		...
		StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>()
		{
			...
			public void onResponse(String response)
			{
				...
				new Response.ErrorListener()
				{
					...
					{
						Toast.makeText(CompletedOrder.this, error.getMessage().toString(), Toast.LENGTH_LONG).show();
					}
				});
	...
	private void displayInfo() {
		AlertDialog.Builder adb = new AlertDialog.Builder(CompletedOrder.this, R.style.MyAlertDialogStyle);
		adb.setTitle("Completed Orders Information");
		adb.setMessage("This is where you can view the completed orders by your warehouse. If for some reason, you didn't ship the right items" +
				" you can still change the status from completed to pending.");
