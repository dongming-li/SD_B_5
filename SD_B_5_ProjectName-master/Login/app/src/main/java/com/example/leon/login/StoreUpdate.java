...
public class StoreUpdate extends OperationActivity implements View.OnClickListener {
    ...
    private String url = "http://proj-309-sd-b-5.cs.iastate.edu/database/update_store.php";
    ...
    private void add() {
        if (email.getText().toString().isEmpty() && street_address.getText().toString().isEmpty() &&
            ...
            Toast.makeText(StoreUpdate.this, "At least one of the fields is empty.", Toast.LENGTH_LONG).show();
            ...
            StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    progressBar.setVisibility(View.INVISIBLE);
                    Toast.makeText(getApplicationContext(), "Store Updated", Toast.LENGTH_LONG).show();
                    finish();
                ...
                protected Map<String, String> getParams() {
                    ...
                    //parameters.put("userType", LoginActivity.user_Type); //UserType 4
    ...
    private void displayInfo() {
        AlertDialog.Builder adb = new AlertDialog.Builder(StoreUpdate.this, R.style.MyAlertDialogStyle);
        adb.setTitle("Update the store information");
        adb.setMessage("This is where you can makes changes about the details of your company's warehouse. Fill out the details to " +
