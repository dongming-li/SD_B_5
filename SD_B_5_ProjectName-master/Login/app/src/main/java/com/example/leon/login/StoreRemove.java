...
public class StoreRemove extends OperationActivity implements View.OnClickListener {
    ...
    private void removeStore() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url_search, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                progressBar.setVisibility(View.INVISIBLE);
                Toast.makeText(getApplicationContext(), "Store Removed", Toast.LENGTH_LONG).show();
                finish();
    ...
    private void displayInfo() {
        AlertDialog.Builder adb = new AlertDialog.Builder(StoreRemove.this, R.style.MyAlertDialogStyle);
        adb.setTitle("Remove Store Information");
        adb.setMessage("This is where you can remove the store from the company. Just click on the button and it will remove the " +
                "store you are located in.");
