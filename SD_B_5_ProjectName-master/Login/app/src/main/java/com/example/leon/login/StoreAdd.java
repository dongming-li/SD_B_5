...
public class StoreAdd extends OperationActivity implements View.OnClickListener {
    ...
    private void add() {
        if (email.getText().toString().isEmpty() || street_address.getText().toString().isEmpty() ||
            ...
            Toast.makeText(StoreAdd.this, "At least one of the fields is empty.", Toast.LENGTH_LONG).show();
            ...
            StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    progressBar.setVisibility(View.INVISIBLE);
                    Toast.makeText(getApplicationContext(), "Store Created", Toast.LENGTH_LONG).show();
                    finish();
    ...
    private void getLatLong(String strAddress) throws IOException {
        ...
        if (address == null) {
            Toast.makeText(StoreAdd.this, "Error: Invalid address", Toast.LENGTH_LONG).show();
        } else {
    ...
    private void displayInfo() {
        AlertDialog.Builder adb = new AlertDialog.Builder(StoreAdd.this, R.style.MyAlertDialogStyle);
        adb.setTitle("Create a store information");
        adb.setMessage("This is where you can create a store for your company. Fill out the important details about your store.");
