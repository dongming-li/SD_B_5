...
$sql = 'CREATE TABLE product'.$company_id.'(UPC INT NOT NULL, PRODUCT_NAME VARCHAR(50) NOT NULL, QUANTITY INT NOT NULL, DESCRIPTION VARCHAR(50), BIN_ID INT NOT NULL, MANUFACTURER_PRICE VARCHAR(10), MSRP VARCHAR(10), LOCATION_ID INT NOT NULL, ARCHIVE INT NOT NULL, PRIMARY KEY (UPC))';
